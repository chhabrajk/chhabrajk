...
I'm a **Senior Data Analytics professional** with **10 years of experience** turning raw data into decisions that actually move the needle.

Over the past decade, I've worked across industries — **Finance, Retail, E-Commerce, SaaS, and Healthcare** — building everything from executive dashboards to production-grade ML models.

What I believe: **data should tell a story, not just sit in a table.**
...
```text
📊  Business Intelligence      Power BI · Tableau · Plotly Dash
🐍  Python Analytics           Pandas · NumPy · Scikit-learn · XGBoost
🗄️  Data Engineering           SQL · SQLite · ETL Pipelines · Automation
🔮  Predictive Modeling        Forecasting · Churn · Classification · Regression
📣  Marketing Analytics        GA4 · Meta Ads · Attribution · Funnel Analysis
💰  Financial Analytics        KPI Dashboards · Unit Economics · SaaS Metrics
```
...
I'm actively taking on freelance analytics projects. Here's what I typically help clients with:

- 🔹 **BI Dashboards** — Power BI, Tableau, or Plotly Dash for your team
- 🔹 **Predictive Models** — Churn, demand forecasting, lead scoring
- 🔹 **ETL Automation** — Replace manual reporting with automated pipelines
- 🔹 **Financial Modeling** — SaaS metrics, unit economics, investor dashboards
